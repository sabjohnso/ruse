...
namespace ruse::reference {
   ...
   /**
    * @brief Return `true` if the input is a type proxy for a hoisted
    * value type. Otherwise, return `false`.
    */
   ...
   /**
    * @brief Return `true` if the input is a hoisted value. Otherwise,
    * return `false`.
    */
   ...
   /**
    * @brief Return true if the input is a type proxy for a hoisted list
   ...
   /**
    * @brief Return `true` if the input is a hoisted list. Otherwise,
    * return `false`.
    */
   ...
   constexpr auto hoist_default = []<Thunk F>(F) {
      ...
      if constexpr(List<result>) {
         return []<auto... Indices>(index_sequence<Indices...>) {
            return hoisted_list<
              list_ref(nat<Indices>, result_value)...>{};
         }
