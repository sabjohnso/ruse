...
namespace ruse::reference {
   ...
   /**
    * @brief Return a function that will return the result of the first
    * of the input functions that is invocable with the arguments
   ...
   /**
    * @brief Apply a function to input arguments where the last of the
    * input arguments is a list that will be spliced into the other
    * arguments.
    */
   ...
   /**
    * @brief Return a function that will accept a function that is
    * invocable over the input arguments and return the result of that
    * application.
    */
   ...
   /**
    * @brief Return a function that will accept a function that is
    * invocable over the input list of arguments and return the result
    * of that application.
    */
