...
namespace ruse::reference {
   ...
   /**
    * @brief A data struct template whose instances ack as proxies for
    * the template template parameter or a partial application of the
    * template template parameter over the type template parameters.
    */
   ...
   /**
    * @brief A proxy for the the partial application of the template
   ...
   constexpr auto template_of =
     []<template<typename...> class K, typename T, typename... Ts>(
       K<T, Ts...>) { return tmplt<K, Ts...>; };

   /**
    * @brief Return true if the input is a trype proxy for a
    * template_proxy type. Otherwise, return false.
    */
   ...
   /**
    * @brief Return true if the input is a trype proxy for a
    * template_proxy type lacking any partial application. Otherwise,
    * return false.
    */
   ...
   /**
    * @brief Return true if the input is a template proxy.  Otherwise,
    * return `false`.
    */
   ...
   /**
    * @brief Return a proxy to the template of the input type type
    * proxy.
    */
    ...
    * specialialization of the template specifield in the template
   ...
   concept TemplateSpec =
     is_template_proxy_type(type<TemplateProxy>) and
