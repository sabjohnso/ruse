...
namespace ruse::experimental
{
  ...
  struct equality
  {
    friend
    constexpr bool
    operator ==(T, T){ return true; }

    template<typename U>
    friend constexpr bool
    operator ==(T, U){ return false; }

    template<typename U>
    friend constexpr bool
    operator !=(T x, U y){ return !(x == y); }

  };

  template<typename ... Rules>
  struct grammar
    : equality<grammar<Rules ...>>
  {
    ...
    , equality<zero_or_more<Form>>
  {
    ...
    operator,(zero_or_more, T){ return (sequence<zero_or_more>{}, T{}); }
  };
    ...
    , equality<one_or_more<Form>>
  {
    template<typename T>
    friend constexpr auto
    operator,(one_or_more, T){ return (sequence<one_or_more>{}, T{}); }
  };
    ...
    , equality<zero_or_one<Form>>
  {
    template<typename T>
    friend constexpr auto
    operator,(zero_or_one, T){ return (sequence<zero_or_one>{}, T{}); }
  };
    ...
    , modifiable<terminal<Str>>
  {
    template<typename T>
    friend constexpr auto
    operator,(terminal, T){ return (sequence<terminal>{}, T{}); }
  };
    ...
    , modifiable<semiterminal<Str>>
  {
    ...
    template<typename T>
    friend constexpr auto
    operator,(semiterminal, T){ return (sequence<semiterminal>{}, T{}); }
  };
    ...
    , modifiable<nonterminal<Str>>
  {
    ...
    template<typename T>
    friend constexpr auto
    operator,(nonterminal, T){ return (sequence<nonterminal>{}, T{}); }
  };
  ...
  template<typename Name, typename ... Alternatives>
  std::ostream&
  operator <<(std::ostream& os, production_rule<Name, Alternatives...>){
    os << Name{};
