...
namespace ruse::testing {
   ...
   //   STATIC_EXPECT_EQ(
   //     hoisted<'a'>{}, plist_ref("value"_tag, head(output)).value);
   //   STATIC_EXPECT_EQ("bc"_hoist, plist_ref("sequence"_tag,
   //   head(output)).value);
   // }
   ...
   //   STATIC_EXPECT_TRUE(is_plist(head(output)));
   //   STATIC_EXPECT_EQ(
   //     hoisted<nothing_s{}>{}, plist_ref("value"_tag,
   //     head(output)).value);
   //   STATIC_EXPECT_EQ(""_hoist, plist_ref("sequence"_tag,
   //   head(output)).value);
   // }
   ...
   // TEST(parse, conj)
   // {
   //   constexpr auto output = conj(
   //     item, [](auto x) { return result(x); }, "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }
   ...
   // TEST(parse, disj)
   // {
   //   constexpr auto output = disj(item, item, "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   ...
   // {
   //   constexpr auto output = disj(fail, item, "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }
   ...
   // {
   //   constexpr auto output = disj(item, fail, "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }
   ...
   // {
   //   constexpr auto output = disj(fail, fail, "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nothing(output));
   // }

   // TEST(parse, alt)
   // {
   //   constexpr auto output = alt(result(hoisted<'a'>{}), item,
   //   "bc"_hoist); STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }

   // TEST(parse, fail_second)
   // {
   //   constexpr auto output = alt(result(hoisted<'a'>{}), fail,
   //   "bc"_hoist); STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }
   ...
   // {
   //   constexpr auto output = alt(fail, item, "bc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   // }
   ...
   // {
   //   constexpr auto output = alt(fail, fail, "bc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nothing(output));
   // }

   // TEST(parse, sat)
   // {
   //   constexpr auto output = sat(
   //     []<auto Value>(hoisted<Value>) { return Value == 'a'; },
   //     "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   // }
   ...
   // {
   //   constexpr auto output = sat(
   //     []<auto Value>(hoisted<Value>) { return Value == 'b'; },
   //     "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nothing(output));
   // }
   ...
   // {
   //   constexpr auto opt =
   //     curry(nat<1>, [](auto parser) { return alt(parser,
   //     result(nothing));
   //     });
   //   constexpr auto output = opt(
   //     sat([]<auto Value>(hoisted<Value>) { return Value == 'a'; }),
   //     "abc"_hoist);
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   //   STATIC_EXPECT_EQ('a', parse_result_value(head(output)).value);
   //   STATIC_EXPECT_EQ("bc"_hoist,
   //   parse_result_sequence(head(output)));
   // }

   // TEST(parse, equal)
   // {
   //   constexpr auto parser = conj(equal<'a'>, [](auto) {
   //     return conj(equal<'b'>, [](auto) {
   //       return conj(equal<'c'>, [](auto) {
   //         return result(hoisted_list<'a', 'b', 'c'>{});
   //       });
   //     });
   //   });
   ...
   //   constexpr auto parser = seq<equal<'a'>, equal<'b'>, equal<'c'>>;
   ...
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   //   STATIC_EXPECT_EQ(hoisted<'a'>{},
   //   parse_result_value(head(output)));
   // }
   ...
   //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
   //   STATIC_EXPECT_EQ(1, length(output));
   //   STATIC_EXPECT_EQ(hoisted_nothing,
   //   parse_result_value(head(output))); STATIC_EXPECT_EQ("bbc"_hoist,
   //   parse_result_sequence(head(output)));
   // }
