...
namespace ruse::testing {
  ...
  //   STATIC_EXPECT_TRUE(is_plist(head(output)));
  //   STATIC_EXPECT_EQ(
  //     hoisted<nothing_s{}>{}, plist_ref("value"_tag, head(output)).value);
  ...
  // TEST(parse, alt)
  // {
  //   constexpr auto output = alt(result(hoisted<'a'>{}), item, "bc"_hoist);
  //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
  //   STATIC_EXPECT_EQ(1, length(output));
  // }
  ...
  // {
  //   constexpr auto output = alt(result(hoisted<'a'>{}), fail, "bc"_hoist);
  //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
  //   STATIC_EXPECT_EQ(1, length(output));
  // }
  ...
  //     []<auto Value>(hoisted<Value>) { return Value == 'a'; }, "abc"_hoist);
  //   STATIC_EXPECT_TRUE(is_nonempty_list(output));
  // }
  ...
  // {
  //   constexpr auto output = sat(
  //     []<auto Value>(hoisted<Value>) { return Value == 'b'; }, "abc"_hoist);
  //   STATIC_EXPECT_TRUE(is_nothing(output));
  // }
  ...
  // {
  //   constexpr auto opt =
  //     curry(nat<1>, [](auto parser) { return alt(parser, result(nothing));
  //     });
